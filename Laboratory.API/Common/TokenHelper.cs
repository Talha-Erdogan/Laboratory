...
namespace Laboratory.API.Common
{
    public static class TokenHelper
    {
        ...
        public static string CreateToken(Employee employee, string userAuthCodeListAsString)
        {
            ...
            var token = new JwtBuilder()
              ...
              .AddClaim("ID", employee.Id)
              .AddClaim("name", employee.Name)
              .AddClaim("lastName", employee.LastName)
