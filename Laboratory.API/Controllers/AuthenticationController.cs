...
using Laboratory.API.Models.Authentication;
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public IActionResult Token([FromBody] TokenRequestModel requestModel, [FromHeader] string displayLanguage)
        {
            ...
            if (userLoginResponse.IsValid)
            {
                ...
                responseModel.Data.Id = userLoginResponse.Employee.Id;
                responseModel.Data.TC = userLoginResponse.Employee.TC;
                responseModel.Data.Name = userLoginResponse.Employee.Name;
                responseModel.Data.LastName = userLoginResponse.Employee.LastName;
                responseModel.Data.Phone = userLoginResponse.Employee.Phone;
                responseModel.Data.Address = userLoginResponse.Employee.Address;
                responseModel.Data.UserName = userLoginResponse.Employee.UserName;
                responseModel.Data.Password = "-";
                responseModel.Data.TokenExpirePeriod = 60;

                // kullanıcının authcode bilgileri elde edilir
                var userAuthCodeListAsString = _profileDetailService.GetAllAuthCodeByEmployeeIdAsConcatenateString(userLoginResponse.Employee.Id);

                //jwt token eklenmesi işlevi
                responseModel.Data.UserToken = TokenHelper.CreateToken(userLoginResponse.Employee, userAuthCodeListAsString); //userToken.Token;
